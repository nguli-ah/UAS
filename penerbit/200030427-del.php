...
$sql="delete from t_penerbit where (id_penerbit = '$id_penerbit');";
...
if ($del){	
    ...
    echo "<script>alert('Penerbit telah berhasil dihapus.'); document.location='index.php'</script>";
} 
else {
    echo "<script>alert('Penerbit gagal dihapus. Silahkan ulangi kembali.'); document.location='index.php'</script>";
}
